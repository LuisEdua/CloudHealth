...
DataRoutes = Blueprint("/tratamientos", __name__)

#Listar tratamientos
@DataRoutes.route('/tratamientos/listar', methods=['GET'])
...
@DataRoutes.route('/tratamientos/<uuid>', methods=['GET'])
...
#Crear tratamientos
@DataRoutes.route('/tratamientos/crear', methods=['POST'])
...
@DataRoutes.route('/tratamientos/actualizar/<string:uuid>', methods=['PUT'])
...
@DataRoutes.route('/tratamientos/eliminar/<uuid>', methods=['DELETE'])
