...
class MySQLPacientesModels(Base):
    ...
    def to_json(self):
        return {
            ...
            "habitacion": self.cama.habitacion.number if self.cama and self.cama.habitacion else None,
            "pabellon": self.cama.habitacion.area.name if self.cama and self.cama.habitacion and self.cama.habitacion.area else None,
